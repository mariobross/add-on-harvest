...
<script src="<?php echo base_url('/files/');?>global_assets/js/plugins/uploaders/fileinput/plugins/purify.min.js"></script>
<script src="<?php echo base_url('/files/');?>global_assets/js/plugins/uploaders/fileinput/plugins/sortable.min.js"></script>
<script src="<?php echo base_url('/files/');?>global_assets/js/plugins/uploaders/fileinput/fileinput.min.js"></script>
...
<script src="<?php echo base_url('/files/');?>global_assets/js/demo_pages/uploader_bootstrap.js"></script>
