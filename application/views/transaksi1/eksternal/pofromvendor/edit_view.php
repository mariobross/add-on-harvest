				...
				$("#btn-update").click(function(){
					...
					if(emptygrpo){
						$.ajax({
							...
							type:"POST",
							data:{id_grpo_header:idGrpoHeader, pstDate:postingDate, RemarkHead:remarkHead, detail_grQty:grQty, remark:remark, idGrpoDetails:id_grpo_detail },
				...
				$("#btn-approve").click(function(){
					...
					if(emptygrpo){
						$.ajax({
							url:"<?php echo site_url('transaksi1/pofromvendor/editTable');?>",
							type:"POST",
							data:{id_grpo_header:idGrpoHeader, appr:approve, pstDate:postingDate, RemarkHead:remarkHead, detail_grQty:grQty, remark:remark, idGrpoDetails:id_grpo_detail },
							success:function(res){
								location.reload(true);
							}
						});
