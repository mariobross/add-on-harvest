		...
		<div class="page-content">
			...
			<div class="content-wrapper">
                ...
                <?php if ($this->session->flashdata('success')): ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <legend class="font-weight-semibold"><i class="icon-list mr-2"></i>List of Transfer Out</legend>
                    ...
                    "columns": [
                        ...
                        {"data":"id_gistonew_out_header", "className":"dt-center", render:function(data, type, row, meta){
                            rr = `<div style="width:100px">
                                        ...
                                        ${freeze=='N' || ids || am==1 || rm==1 ? `<a href='<?php echo site_url('transaksi1/transferoutinteroutlet/edit/')?>${data}' ><i class='icon-file-plus2' title="Edit"></i></a>&nbsp;` : ''}
                                    </div>`;
                            return rr;
                        }},
                        {"data":"id_gistonew_out_header"},
                        {"data":"gistonew_out_no1"},
                        {"data":"po_no1"},
                        {"data":"posting_date"},
                        {"data":"request_to"},
                        {"data":"status"},
