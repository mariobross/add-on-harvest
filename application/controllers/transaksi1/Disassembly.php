...
<<<<<<< HEAD
    ...
    public function index(){
        ...
        $this->load->view('transaksi1/produksi/disassembly/list_view', $object);
=======
        $this->load->model('transaksi1/disassembly_model', 'diss_model');
    }
...
=======
            return $this->session->set_flashdata('failed', "Disassembly Gagal dihapus");
>>>>>>> 8281b7891b2d52ae86f2a0749f32dd848350def3
        }
    }
...
<<<<<<< HEAD
				...
				$nestedData['uom'] = $uom;
				$nestedData['OnHand'] = $inWhs[0]['OnHand']!='.000000' ? $inWhs[0]['OnHand'] : 0;
=======
...
<<<<<<< HEAD
=======
				// $querySAP = $this->diss_model->wo_detail_valid('1ACRG004');
>>>>>>> 8281b7891b2d52ae86f2a0749f32dd848350def3
				$validFor = '';
				$decreasAc = '';
				if($querySAP != false){
...
=======
				// $qty = $this->diss_model->wo_detail_quantity($kode_paket,$data['material_no']);
				$qty_paket = $data['quantity'];
...
=======
				...
				$queryUOM = $this->diss_model->disassembly_detail_uom($data['material_no']);
				// $queryUOM = $this->diss_model->disassembly_detail_uom('1ACO158');
				if(count($queryUOM)>0){
					$uom = $queryUOM[0]['UNIT'];
				}
				
				$querySAP2 = $this->diss_model->disassembly_detail_itemcodebom($kode_paket,$data['material_no']);
				// $querySAP2 = $this->diss_model->disassembly_detail_itemcodebom('FDY0020','1ACO158');
				// print($querySAP2);
